...
with open('text.csv','r') as input:
    for row in csv.reader(input):
        ...
        for i in named_entity:
            if i[1] == 'NUMBER' or i[1] == 'CAUSE_OF_DEATH' or i[1] == 'DATE' or i[1] == 'ORGANIZATION' or i[1] == 'PERCENT' or i[1] == 'PERSON' or i[1] == 'LOCATION' or i[1] == 'MONEY' or i[1] == 'TIME' or i[1] == 'MISC' or i[1] == 'CITY' or i[1] == 'COUNTRY' or i[1] == 'IDEOLOGY' or i[1] == 'CRIMINAL_CHARGE' or i[1] == 'NATIONALITY' or i[1] == 'RELIGION' or i[1] == 'STATE_OR_PROVINCE' or i[1] == 'TITLE' or i[1] == 'DURATION':
                if (p) and (p[-1][1] == i[1]):
                    temp = list(p[-1])
                    temp.insert(-1,i[0])
                    p[-1] = tuple(temp)
